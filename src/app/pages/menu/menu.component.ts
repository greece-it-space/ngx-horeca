...
const MENU_PAGE_CONFIG: Record<DishMenuPage, MenuPageConfig> = {
	...
	favorites: {
		emptyDescription: 'Προσθέστε στοιχεία από το μενού στα αγαπημένα και θα εμφανιστούν εδώ.',
		emptyTitle: 'Δεν υπάρχουν αποθηκευμένα πιάτα',
		icon: 'favorite',
		title: 'Αγαπημένο',
		url: '/favorites',
	},
	seasonal: {
		emptyDescription: 'Οι εποχιακές προσφορές θα εμφανιστούν εδώ όταν είναι διαθέσιμες.',
		emptyTitle: 'Δεν υπάρχουν εποχιακές προσφορές',
		icon: 'local_florist',
		title: 'Εποχιακές προσφορές',
		url: '/seasonal',
	},
	daily: {
		emptyDescription: "Το μενού ημέρας θα εμφανιστεί εδώ όταν είναι διαθέσιμο.",
		emptyTitle: "Το μενού ημέρας δεν είναι διαθέσιμο",
		icon: 'today',
		title: "Μενού ημέρας",
		url: '/daily',
	},
