			...
			<section class="overflow-hidden rounded-[1.2rem] border border-[var(--c-border)] bg-[var(--c-bg-secondary)] shadow-[var(--shadow-sm)]">
				<div class="border-b border-[var(--c-border)] bg-[linear-gradient(135deg,rgba(197,61,61,0.14),rgba(217,168,88,0.08))] px-4 py-6 sm:px-6 sm:py-8">
					...
					<h1 class="mt-2 max-w-[44rem] text-2xl font-semibold leading-tight text-[var(--c-text-secondary)] sm:text-4xl">
						<span [translate]="'Πακέτα φαγητού και εξυπηρέτησης για ιδιωτικές και επαγγελματικές εκδηλώσεις'">
							Πακέτα φαγητού και εξυπηρέτησης για ιδιωτικές και επαγγελματικές εκδηλώσεις
						</span>
					</h1>
					<p class="mt-3 max-w-[42rem] text-sm leading-6 text-[var(--c-text-muted)] sm:text-base">
						<span [translate]="'Οργανώστε γενέθλια, γάμους, εταιρικές συναντήσεις και οικογενειακές γιορτές με ευέλικτα μενού και μορφές εξυπηρέτησης.'">
							Οργανώστε γενέθλια, γάμους, εταιρικές συναντήσεις και οικογενειακές γιορτές με ευέλικτα μενού και μορφές εξυπηρέτησης.
						</span>
					</p>
				</div>
				...
				<section class="border-t border-[var(--c-border)] p-3 sm:p-4" aria-labelledby="catering-process-title">
					<div class="rounded-[1rem] border border-[var(--c-border)] bg-[var(--c-bg-primary)] p-4">
						<p class="text-[12px] font-semibold uppercase tracking-[0.18em] text-[var(--c-secondary)]">
							<span [translate]="'Διαδικασία σχεδιασμού'">Διαδικασία σχεδιασμού</span>
						</p>
						<h2 id="catering-process-title" class="mt-2 text-xl font-semibold text-[var(--c-text-secondary)]">
							<span [translate]="'Πείτε μας την ημερομηνία, τον αριθμό επισκεπτών και τη μορφή που προτιμάτε'">
								Πείτε μας την ημερομηνία, τον αριθμό επισκεπτών και τη μορφή που προτιμάτε
							</span>
						</h2>
						...
						<a class="ui-btn ui-btn-primary mt-5" routerLink="/socials">
							...
							<span [translate]="&quot;Επικοινωνήστε μαζί μας&quot;">Επικοινωνήστε μαζί μας</span>
						</a>
					</div>
				</section>
			</section>
...
export class CateringComponent {
	...
	protected readonly packages = [
		{
			icon: 'cake',
			title: 'Γενέθλια και οικογενειακές γιορτές',
			description: 'Χαλαρά σετ, γλυκά, ποτά και επιλογές σερβιρίσματος για ζεστές γιορτές.',
		},
		{
			icon: 'volunteer_activism',
			title: 'Γάμοι και δεξιώσεις',
			description: 'Εορταστικά μενού, υποστήριξη στον χρονισμό και λεπτομέρειες εξυπηρέτησης για σημαντικές ημερομηνίες.',
		},
		{
			icon: 'business_center',
			title: 'Εταιρικές εκδηλώσεις',
			description: 'Coffee breaks, γεύματα, δείπνα και μορφές δεξίωσης για ομάδες και επισκέπτες.',
		},
	];
	protected readonly process = [
		'Επιλέξτε ένα πακέτο ή ζητήστε προσαρμοσμένο μενού.',
		'Συμφωνήστε την προετοιμασία, την παράδοση, το στήσιμο και τον χρόνο εξυπηρέτησης.',
		'Επιβεβαιώστε τον τελικό αριθμό επισκεπτών πριν από την εκδήλωση.',
	];
