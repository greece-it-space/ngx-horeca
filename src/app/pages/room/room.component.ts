...
export class RoomComponent {
	...
	protected readonly facts = computed(() =>
		[
			{ label: 'Μέγεθος δωματίου', value: this.room().size },
			{ label: 'Χωρητικότητα', value: this.room().occupancy },
			{ label: 'Κρεβάτι', value: this.room().bed },
			{ label: 'Μπάνιο', value: this.room().bathroom },
